                   ...
                   <div class="row">
                       <div class="col-md-3 cl-height r" style="background-color: white; color:black;font-size: large; border-right: 1px solid black;">
                           ...
                           <ul style="list-style: none;">
                               <li><a class="btn btn-default btn-block active "  href="<?php echo base_url(); ?>home/accsetting"><span class="glyphicon glyphicon-wrench pull-left" aria-hidden="true" ></span>  Account Setting</a></li>
